...
对比于Dubbo，SpringCloud的服务调用效率，参考网上的一篇[实验]()，有入校结论，无论是数据量大或小，Dubbo的性能都远高于SpringCloud。但是由于Dubbo在2017年前后断断续续已经没有更新，所以更加活跃SpringCloud体系得到广泛使用。
...
![springcloud](https://phaedo.github.io/blog/post-assets/springcloud.png)
